...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1079360139,1079360139}
print("\27[34m"..[[
...
local res = https.request('https://tshake.ga/LeonardoTeam.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
...
os.execute('rm -rf LeonardoTeam.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/LeonardoTeam/LeonardoTeam/master/LeonardoTeam.lua', 'LeonardoTeam.lua') 
download_to_file('https://raw.githubusercontent.com/LeonardoTeam/LeonardoTeam/master/start.lua', 'start.lua') 
dofile('LeonardoTeam.lua')  
return false
end
...
if Get_info then
local TextS = "\n📂┇اهلا بك في متجر ملفات ليوناردو \n☽┇الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
